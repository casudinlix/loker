...
<ul class="x-navigation">
    ...
    <li class="xn-profile">
        ...
        <div class="profile">
            ...
            <div class="profile-data">
                <div class="profile-data-name">{{ Auth::user()->name ?? "Guest" }}</div>
            <div class="profile-data-title">{{ Auth::user()->email ?? "Guest@guest.com"  }} {{nim()}}</div>
            </div>
    ...
    <li class="">
        <a href="{{route('mahasiswa.home')}}"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>
    </li>
    ...
    <li class="xn-openable">
        ...
        <ul>
            <li><a href="{{ route('kartu-studi.index') }}"><span class="fa fa-file-o"></span>KRS</a></li>
            <li><a href="{{ route('kartu-studi.index') }}"><span class="fa fa-file-text-o"></span>KHS</a></li>
            <li><a href="{{ route('kartu-studi.index') }}"><span class="fa fa-book"></span>Tugas</a></li>
            <li><a href="{{ route('kartu-studi.index') }}"><span class="fa fa-bar-chart-o"></span>Nilai</a></li>
