  ...
  <div class="col-md-12">
                              ...
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                      <h3 class="panel-title">Ruang Kelas</h3>
                                      <ul class="panel-controls">
                                           <li><a href="{{ route('kelas.create') }}" rel="modal:open" class="panel" data-toggle="tooltip" data-placement="top" title="Tambah data" ><span class="fa fa-plus"></span></a></li>
                                  ...
                                  <div class="panel-body">
                                      <table id="kelas" class="table" width="100%">
                                          <thead>
                                              <tr>
                                                  <th>No</th>
...
var krsconfig=  $('#kelas').DataTable({
    ...
    columns: [
        ...
        {data: 'kapasitas', name: 'kapasitas',orderable: false},
